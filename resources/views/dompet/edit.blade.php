                    ...
                    <div class="portlet light portlet-fit portlet-form bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark bold uppercase">Edit Dompet</span>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <form action="{{ route('dompet.update',$dompet->id) }}" id="my-form" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                {!! csrf_field() !!}
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 {{($errors->has('nama')? 'has-error' : '')}}">
                                                        <div class="input-icon right">
                                                            <i></i>
                                                            <input type="text" class="form-control" name="nama" placeholder="Nama" value="{{ old('nama',$dompet->nama) }}"/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8 {{($errors->has('referensi')? 'has-error' : '')}}">
                                                        <div class="input-icon right">
                                                            <i></i>
                                                            <input type="text" class="form-control" name="referensi" placeholder="Referensi" value="{{ old('referensi',$dompet->referensi) }}"/>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10 {{($errors->has('deskripsi')? 'has-error' : '')}}">
                                                        <div class="input-icon right">
                                                            <i></i>                                                            
                                                            <textarea name="deskripsi" class="form-control">{{ old('deskripsi',$dompet->deskripsi) }}</textarea>
                                                            ...
                                                            <select name="status" class="form-control" id="select2">
                                                                @foreach($dompetStatus as $status)
                                                                    <option value="{{ $status->id }}"
                                                                        {{ old('status',$dompet->dompet_status_id) == $status->id ? 'selected' : '' }}>
                                                                        {{ $status->nama }}
                                                                    </option>
                                                                @endforeach                                                                                                                    
                                                            </select>
...
@section('close_html')
    ...
    {!! JsValidator::formRequest('App\Http\Requests\Dompets\UpdateDompetFormRequest', '#my-form'); !!}
@endsection
